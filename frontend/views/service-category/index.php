 ...
 * @var common\models\ServiceCategorySearch $searchModel
 */
...
?>
<div class="giiant-crud service-category-index">
                ...
                [
                    ...
                    'dropdown' => [
                        ...
                        'items' => [
                            [
                                'url' => ['shop/index'],
                                'label' => '<i class="glyphicon glyphicon-arrow-left"></i> ' . Yii::t('app', 'Shop'),
                            ],
                            [
                                'url' => ['firm/index'],
