...
?>
<div class="giiant-crud shop-view">
    ...
    <div class="clearfix crud-navigation">
        ...
        <div class='pull-left'>
            ...
            ['create', 'id' => $model->id, 'Shop'=>$copyParams],
    ...
    <?php $this->beginBlock('common\models\Shop'); ?>
...
[
    ...
    'value' => ($model->getFirm()->one() ? 
        ...
        Html::a('<i class="glyphicon glyphicon-paperclip"></i>', ['create', 'Shop'=>['firm_id' => $model->firm_id]])
        : 
 ...
 [
    ...
    'content' => $this->blocks['common\models\Shop'],
    'active'  => true,
],
 ]
                 ]
